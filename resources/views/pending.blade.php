                ...
                {{-- NAV BAR --}}
                    <nav class="navbar navbar-expand-lg text-white border-bottom">
                        <div class="container-fluid">
                            ...
                            <h4 class="ms-2">APPOINTMENT STATUS</h4>
                        ...
                        <div class="container-fluid">
                            <div class="container-fluid bg-light px-5 py-4 bg-body rounded shadow-lg">
                                <ul class="nav nav-tabs mb-4 reportsLink">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/vaccinationReports">Pending</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/dewormingReports">Accept</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/heartWormReports">Confirmed</a>
                                    </li>
                                </ul>
