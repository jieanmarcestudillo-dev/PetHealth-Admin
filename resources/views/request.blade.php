...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="container-fluid bg-light px-5 py-4 bg-body rounded shadow-lg">
                                <ul class="nav nav-tabs mb-4 reportsLink">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="/adminAcceptAppointment">Confirmed</a>
                                    </li>
                                    {{-- <li class="nav-item">
                                        <a class="nav-link" href="/adminCompleteAppointment">Completed</a>
                                    </li> --}}
                                </ul>
                                <table id="allPendingAppointmentFunction" class="table table-bordered text-center align-middle">
                                    <thead>
                                        <tr>
    ...
    {{-- JS --}}
        ...
        <script src="{{ asset('/js/appointment/pending.js') }}"></script>
    {{-- END JS --}}
</body>
</html>