...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="container-fluid bg-light px-5 py-4 bg-body rounded shadow-lg">
                                <ul class="nav nav-tabs mb-4 reportsLink">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="/groomingReports">Grooming</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/otherReports">Other Treatment</a>
                                    </li>
                                </ul>
                                <table id="groomingReports" class="table table-bordered text-center align-middle">
                                    <thead>
                                        <tr>
    ...
    {{-- JS --}}
        ...
        <script src="{{ asset('/js/reports/grooming.js') }}"></script>
    {{-- END JS --}}
</body>
</html>