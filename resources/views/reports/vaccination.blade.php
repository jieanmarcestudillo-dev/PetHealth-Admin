...
<body>
                        ...
                        <div class="container-fluid">
                            <div class="container-fluid bg-light px-5 py-4 bg-body rounded shadow-lg">
                                <ul class="nav nav-tabs mb-4 reportsLink">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#">Vaccination</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <table id="vaccinationReports" class="table table-bordered text-center align-middle">
                                    <thead>
                                        <tr>
    ...
    {{-- JS --}}
        ...
        <script src="{{ asset('/js/reports/vaccination.js') }}"></script>
    {{-- END JS --}}
</body>
</html>