    ...
    function allPendingAppointmentFunction(){
            ...
            "columns":[
                ...
                {"data": "app_id",
                    ...
                    return '<button type="button" onclick=confirmedAppointment('+data+') class="btn rounded-0 btn-outline-success btn-sm py-2 px-3" data-title="Accept This?"><i class="bi bi-check-lg"></i></button> <button type="button" data-title="Decline This?" onclick=cancelAppointment('+data+') class="btn rounded-0 btn-outline-danger btn-sm py-2 px-3"><i class="bi bi-x-lg"></i></button>'
                }
            }
            ],
            order: [[1, 'asc']],
