...
function allThisDayAppointmentFunction() {
    var table = $("#allThisDayAppointmentFunction").DataTable({
        language: {
        ...
        iDisplayLength: 25,
        ajax: {
            url: "/allThisDayAppointmentFunction",
            dataSrc: "",
            targets: "0",
        },
        columns: [
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response == 1) {
                ...
                $("#allThisDayAppointmentFunction").DataTable().ajax.reload();
                Swal.fire({
                    position: "center",
                    icon: "success",
