$(document).ready(function () {
    allThisMonthAppointmentFunction();
    $.ajaxSetup({
        headers: {
...
function allThisMonthAppointmentFunction() {
    var table = $("#allThisMonthAppointmentFunction").DataTable({
        language: {
        ...
        iDisplayLength: 25,
        ajax: {
            url: "/allThisMonthAppointmentFunction",
            dataSrc: "",
            targets: "0",
        },
        columns: [
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response == 1) {
                ...
                $("#allThisMonthAppointmentFunction").DataTable().ajax.reload();
                Swal.fire({
                    position: "center",
                    icon: "success",
